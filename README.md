...
Telegram-бот для карьерного центра онлайн-университета. Помогает быстро разбирать входящие заказы с фриланс-бирж: определяет стек, проверяет соответствие команде, пишет отклик и готовит пост для Telegram-канала.

---

## Проблема

Ежедневно через карьерный центр проходит 15-30 заказов с различных фриланс бирж. Каждый нужно вручную проанализировать: определить технологии, проверить соответствие скиллсету команды, написать отклик и оформить для публикации. На один заказ уходило 15–20 минут. Бот сокращает это до 1–2 минут.
...
Разработан в рамках финального проекта курса по вайб-кодингу.  
Автор: Елена Снигирева
